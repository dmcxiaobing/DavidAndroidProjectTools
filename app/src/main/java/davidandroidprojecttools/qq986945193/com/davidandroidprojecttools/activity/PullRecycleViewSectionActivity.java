...
import davidandroidprojecttools.qq986945193.com.davidandroidprojecttools.pullRecycleView.base.BaseSectionListActivity;
...
/**
 * 带有自动加载与上拉刷新的sectionactivity recycleView
 */
public class PullRecycleViewSectionActivity extends BaseSectionListActivity<String> {
...
//            PicassoWithImageLoaderImageViewUtils.withImageView(mContext, mDataList.get(position).t, mSampleListItemImg);
//            Glide.with(mSampleListItemImg.getContext())
//                    .load(mDataList.get(position).t)
//                    .centerCrop()
//                    .crossFade()
//                    .into(mSampleListItemImg);
            GlideAndFrescoUtils.withImageView(mContext, mDataList.get(position).t, mSampleListItemImg);
        }
