...
import davidandroidprojecttools.qq986945193.com.davidandroidprojecttools.adapter.CityListAdapter;
import davidandroidprojecttools.qq986945193.com.davidandroidprojecttools.adapter.ResultListAdapter;
 ...
 */
public class CityPickerListActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_city_picker_list);
    ...
    private void back(String city) {
        ToastUtils.show(this, "点击的城市：" + city, Toast.LENGTH_SHORT);
